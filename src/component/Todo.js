        ...
        return (
            ...
            <div className="flex items-center mt-7 gap-2">
                ...
                <div className="flex items-center my-7 bg-gray-200 rounded-full ">
                   ...
                   focus:outline-none h-14 pl-6 pr-2 placeholder: text-slate-600" type="text" placeholder="add your task "/>
                ...
                <div>
                    {todoList.map((item,index)=>{
                        ...
                        isComplate={item.isComplete} deleteTodo={deleteTodo} toggle={toggle}
                        ></TodoItems>
                    } )}
                </div>
